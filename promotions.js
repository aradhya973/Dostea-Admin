document.addEventListener("DOMContentLoaded", function () {
    ...
    function render() {
        ...
        couponsTable.innerHTML = cache.length
            ? `
    ...
    function openNew() {
        ...
        document
            .getElementById("couponId")
            .value = "";

        document
            .getElementById("couponModalTitle")
            .textContent = "New Coupon";
    ...
    function openEdit(id) {
        ...
        document
            .getElementById("minOrder")
            .value = c.min_order_amount ?? 0;
